...
async def suggest_weekly_meal_plan(
    ...
    """
    AI gợi ý thực đơn 7 ngày dựa trên:
    - BMR (từ chiều cao, cân nặng, tuổi, giới tính)
    - Hạn chế ăn uống (dietary_preferences)
    ...
    try:
        ...
        meal_plan = await ai_service.suggest_weekly_meal_plan(user_data)
        
        return {
            "message": "Đã tạo thực đơn tuần thành công!",
            "total_calories_per_day": meal_plan["total_calories_per_day"],
